...
class TestPngfyer < Minitest::Test
  ...
  def test_that_pngfyer_set_font_color_returns_color_rgba_instance_when_multiple_font_color_components_are_set
    new_font_color = test_pngfyer.set_font_color(red: 125, green: 55, blue: 245)

    assert_instance_of(AsciiPngfy::ColorRGBA, new_font_color)
  end

  def test_that_pngfyer_set_font_color_returns_color_rgba_instance_when_all_font_color_components_are_set
  ...
  def test_that_pngfyer_set_font_color_raises_error_when_red_font_color_component_set_to_set_to_invalid_value
  ...
  def test_that_pngfyer_set_font_color_raises_error_when_green_font_color_component_set_to_set_to_invalid_value
  ...
  def test_that_pngfyer_set_font_color_raises_error_when_blue_font_color_component_set_to_set_to_invalid_value
  ...
  def test_that_pngfyer_set_font_color_raises_error_when_alpha_font_color_component_set_to_set_to_invalid_value
